...
public sealed class Attendee : Entity
{
    ...
    public ResponseWrapper CheckIn(Ticket ticket)
    {
        ...
        if (ticket.UsedAtUtc.HasValue)
        {
            ...
            return ResponseWrapper<Guid>.Fail(TicketErrors.DuplicateCheckIn);
        }
