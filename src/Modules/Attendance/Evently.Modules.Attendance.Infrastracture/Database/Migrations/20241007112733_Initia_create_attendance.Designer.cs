...
namespace Evently.Modules.Attendance.Infrastracture.Database.Migrations
{
    ...
    [Migration("20241007112733_Initia_create_attendance")]
    partial class Initia_create_attendance
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Evently.Common.Infrastracture.Inbox.InboxMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Evently.Common.Infrastracture.Inbox.InboxMessageConsumer", b =>
                {
            ...
            modelBuilder.Entity("Evently.Common.Infrastracture.Outbox.OutboxMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Evently.Common.Infrastracture.Outbox.OutboxMessageConsumer", b =>
                {
            ...
            modelBuilder.Entity("Evently.Modules.Attendance.Domain.Attendee.Attendee", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Evently.Modules.Attendance.Domain.Tickets.Ticket", b =>
                {
                    b.HasOne("Evently.Modules.Attendance.Domain.Attendee.Attendee", null)
                        .WithMany()
