...
using Evently.Modules.Attendance.Infrastracture.Authentication;
using Evently.Modules.Attendance.Infrastracture.Database;
using Evently.Modules.Attendance.Infrastracture.Events;
using Evently.Modules.Attendance.Infrastracture.Inbox;
using Evently.Modules.Attendance.Infrastracture.Outbox;
...
namespace Evently.Modules.Attendance.Infrastracture;
...
public static class AttendanceModule
{
        ...
        IConfiguration configuration)
    {
        ...
        services.AddCarterWithAssemblies([Evently.Modules.Attendance.Presentation.AssemblyReference.Assembly]);
