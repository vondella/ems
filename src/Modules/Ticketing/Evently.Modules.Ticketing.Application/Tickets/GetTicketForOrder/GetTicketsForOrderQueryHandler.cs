...
{
    public async  Task<ResponseWrapper<IReadOnlyCollection<TicketResponse>>> Handle(GetTicketsForOrderQuery request, CancellationToken cancellationToken)
    {
        ...
        return ResponseWrapper<IReadOnlyCollection<TicketResponse>>.Success(tickets);
    }
}