...
{
    public async Task<ResponseWrapper> Handle(CreateCustomerCommand request, CancellationToken cancellationToken)
    {
        ...
        return ResponseWrapper<Guid>.Success(request.CustomerId);
    }
}