...
public sealed class Payment : Entity
{
    ...
    public ResponseWrapper Refund(decimal refundAmount)
    {
        if (AmountRefunded.HasValue && AmountRefunded == Amount)
        {
            return ResponseWrapper<decimal>.Fail(PaymentErrors.AlreadyRefunded);
        }
        ...
        return ResponseWrapper<decimal>.Success(refundAmount);
    }
}