...
{
    public async  Task<ResponseWrapper<IReadOnlyCollection<TicketTypeResponse>>> Handle(GetTicketTypesQuery request, CancellationToken cancellationToken)
    {
        ...
        return ResponseWrapper<IReadOnlyCollection<TicketTypeResponse>>.Success(ticketTypes);
    }
}