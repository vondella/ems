...
{
    public async Task<ResponseWrapper<Guid>> Handle(CreateCategoryCommand request, CancellationToken cancellationToken)
    {
        ...
        return ResponseWrapper<Guid>.Success(category.Id);
    }
}