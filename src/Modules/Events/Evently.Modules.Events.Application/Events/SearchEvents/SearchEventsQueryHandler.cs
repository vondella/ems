...
{
    public async  Task<ResponseWrapper<SearchEventsResponse>> Handle(SearchEventsQuery request,
        CancellationToken cancellationToken)
    {
        ...
        return ResponseWrapper<SearchEventsResponse>.Success(new SearchEventsResponse(request.Page, request.PageSize, totalCount, events));
    }
